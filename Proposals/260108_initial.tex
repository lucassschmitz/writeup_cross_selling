...
\begin{itemize}
    ...
    \item What are the welfare effects of cross-selling relative to product-level pricing?  Specifically, what is the impact on equilibrium mark-ups? 
    ...
    incentives to lower prices for new consumers in order to capture future rents. \textcite{dube_switching_2009}, for instance, shows that small switching costs can increase welfare.
    
    \item What is the relative importance of switching costs, persistent unobserved preferences and information asymmetries in driving cross-selling? 
    The regulatory implications of each force differ; thus, effective competition policy requires identifying which factors are most important.
