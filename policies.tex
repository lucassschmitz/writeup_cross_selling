...
\subsubsection{\textcite{cmf_informe_2025}: Manual del Sistema de Informacion (MSI) }
...
\begin{itemize}
    ...
    \item \textbf{Does REDEC share information prior to its implementation? It is implemented in april of 2026, if I borrowed in 2025, would that be included in the system?}
    ...
    Ver siguiente pregunta para entender lo que es el boletin comercial y los distribuidores privados. 
    ...
    \item \textbf{[Judy Chevalier 26-02-26] redec empieza a compartir info de ahora en adelante o tmbn la del pasado? This is important to understand whether the asymmetry disappears with REDEC or if it takes time since for REDEC to be useful the bank needs to observe the consumer for some time.}
\end{itemize}
...
\textcolor{red}{dice que ambas empresas participan en el mercado de buros de credito, pero yo no tenia SIISA como una de las empresas de bureau de creditos relevantes }

%%%%%%%%%%%%% 

\textcite{m_de_hacienda_senado_2024}
