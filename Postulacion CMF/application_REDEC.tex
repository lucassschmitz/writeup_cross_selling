...
Para mitigar estas fallas, diversos países han adoptado marcos de banca abierta (BA) o sistemas de finanzas abiertas (SFA), que otorgan a los consumidores el derecho de compartir su información financiera con terceros autorizados. Estos esquemas, al facilitar el acceso a datos sobre comportamiento de pago y posición crediticia, buscan reducir la selección adversa y aumentar la competencia interbancaria. Como muestra la Figura \ref{fig:map_babina2}, a octubre de 2021 al menos 80 países han implementado o están discutiendo implementar BA (\cite{babina_customer_2025}). De acuerdo con \textcite{babina_customer_2025}, la introducción de BA en el Reino Unido incrementó significativamente la movilidad de los clientes entre bancos y la entrada de nuevas fintechs.

En Chile, la Ley Fintec (2023) establece un marco regulatorio para implementar la banca abierta a partir de 2026. Si bien se espera que esta reforma mejore la competencia y la inclusión financiera (\cite{montoya_lineamientos_2021}), sus efectos distributivos son ambiguos. Un mayor acceso a la información favorece a los prestatarios con buen historial crediticio, ya que  permite reducir  las tasas de equilibrio a las que estos se endeudan. Sin embargo, el intercambio de datos financieros también puede tener efectos no deseados.
 La eliminación de la "renta informacional" del banco incumbente disminuye los incentivos para otorgar  prestamos a clientes  nuevos al sistema, a los cuales nos referiremos como \textit{clientes entrantes}. Esto  genera un aumento en las tasas para individuos sin  historial crediticio (\textcite{sharpe_asymmetric_1990} y \textcite{petersen_effect_1995}). En el Anexo presentamos un modelo que formaliza estas ideas. 
...
Este proyecto tiene como objetivo analizar empíricamente los efectos de la BA en la competencia, la asignación del crédito y la inclusión financiera en Chile.


En particular, busca investigar:  \textbf{como la difusión de información entre bancos afecta el acceso al crédito de distintos grupos, considerando tanto las tasas de interés como los montos de deuda que estos pueden obtener}. 
Según la literatura citada (\cite{sharpe_asymmetric_1990,petersen_effect_1995} entre otros),
es de esperar que estos efectos sean opuestos: para quienes tienen buen historial crediticio, los beneficios competitivos predominarían y mejorarían su acceso al crédito, mientras que para los entrantes, se anticiparía una reducción en dicho acceso debido a la eliminación de las rentas informacionales.
...
En resumen, la introducción de la banca abierta genera impactos potencialmente heterogéneos en distintos segmentos de la sociedad.
Estudiar el impacto heterogéneo de la BA adquiere particular relevancia si se busca mitigar desigualdades dentro del sistema financiero.
Dado que los sectores socioeconómicos mas desfavorecidos tienden a tener menores niveles de inclusión financiera (\cite{centro_uc_para_politicas_publicas_radiografieducacion_2025,cmf_capacidades_2023}), lo cual puede verse exacerbado por la eliminación de las rentas informacionales.
...
Esta investigación está alineada con el mandato legal de la CMF, en particular, su rol de velar por la protección de los clientes y depositantes y promover el desarrollo del mercado financiero. Adicionalmente, el análisis de de la informacion en las decisiones financieras es uno de los temas de interés declarados en la ultima convocatoria de investigación de la CMF\footnote{Ver la ultima convocatoria de investigación: \href{https://www.cmfchile.cl/portal/prensa/615/w3-article-94838.html}{https://www.cmfchile.cl/portal/prensa/615/w3-article-94838.html} }.

%Esta investigación está alineada con la misión institucional de la CMF, en particular, velar por el desarrollo del mercado financiero y facilitar los agentes de mercado. Dada la importancia de la inclusión financiera para el desarrollo y estabilidad financiera \textbf{(OCDE/INFE, 2020)}, este es un tema de interés directo para la CMF. Además de eso, dado que el nivel de competencia en el mercado financiero afecta la tasa de traspaso (\textit{passthrough rate}) de las tasas de interés (\cite{brugues_bank_2024}), la BA puede afectar la efectividad de la política monetaria y la estabilidad financiera, dada la importancia de la tasa de traspaso de la tasa de política monetaria a las tasas del sector privado. \textbf{REESCRIBIR}. Alinea con la intersección de misiones de la CMF y el BCCh.
...
\begin{itemize}
    \item Párrafo 1: Motivación general. Mercados crediticios están plagados por información asimétrica entre bancos: home banks saben más sobre sus propios clients que lo que saben sus competidores. Esto genera poder de mercado, asignación subóptima del crédito, y exclusión de grupos significativos de la población del mercado financiero. En resumen: big problem


\item Párrafo 2: para solucionar esto, se propone la banca abierta. Definir la banca abierta. Explicar que ya se está usando. Explicar los beneficios que se cree que tiene.

    \item Párrafo 3: esos beneficios son estáticos. Explicar los efectos negativos de compartir información. 

    \item Párrafo 4: Dados estos efectos ambiguos de la reforma (sistema de finanzas abiertas, o SFA), es necesaria investigación al respecto. eso es lo que hacemos en este proyecto. Decir claramente la pregunta de investigación acá.

    \item Párrafo 5: Por qué la pregunta de investigación es relevante? Dar una idea de inclusión financiera en chile, del grado de competencia, etc. No sé si queremos poner esto aca. 

    \item Párrafo 6: falta de estudio sobre el tema. Una complicación es que técnicas econométricas estándar (regresión lineal, dif dif) son insuficientes. primero, hay efectos anticipativos (citar paper de reguant sobre paneles solares). Segundo, la dirección del efecto no es clara, así que el treatment effect estimado arriesga decir poco. Entonces, se necesita un modelo que de estructura al los datos blablabla.

    \item Párrafo 7: Segundo, se requieren muchos y muy buenos datos. Por estas razones, chile ofrece un contexto ideal. Las bases de datos de la CMF son destacadas en el mundo por su completitud. Por ello, pedimos:
    \begin{itemize}
        \item Datos individuales de seudores y acreedores sobre:
        \begin{enumerate}
            \item Tarjetas de crédito bancarias y ni bancarias: uso, pago, morosidad.
            \item Préstamos individuales: montos, tasas de interés, planes de pago, vencimiento y morosidad
            \item Cuentas individuales (de ahorr, corriente, vista): saldos y movimientos.
            \item Contratos de préstamo para comprar casas (hipotecas), en caso de que no estén incluidos en el punto anterior. Esto importa porque queremos saber cuál es el \textit{home bank}, algo relevante cuando hay asimetrías de info (Allen et al. 2019 JPE). 
        \end{enumerate}
    \end{itemize}
    \item Cómo esto ayuda a cumplir la misión institucional de la CMF.\footnote{Artículo 1 de la Ley 21.000, que crea la CMF: 
    
    \textit{Artículo 1.- Créase la Comisión para el Mercado Financiero (en adelante también la "Comisión"), como un servicio público descentralizado, de carácter técnico, dotado de personalidad jurídica y patrimonio propio, que se relacionará con el Presidente de la República a través del Ministerio de Hacienda y se regirá por la presente ley y demás normativa que se dicte al efecto.
    Corresponderá a la Comisión, en el ejercicio de sus potestades, velar por el correcto funcionamiento, desarrollo y estabilidad del mercado financiero, facilitando la participación de los agentes de mercado y promoviendo el cuidado de la fe pública. Para ello deberá mantener una visión general y sistémica del mercado, considerando los intereses de los inversionistas
, depositantes y asegurados, así como el resguardo del interés público.
    ...
    Su domicilio será la ciudad de Santiago, sin perjuicio de las oficinas regionales que pueda establecer en otras ciudades del país.}} Dado que el nivel de competencia en un mercado afecta la tasa de pass-though (citar. ej: paper de Brugués), si esta reforma hace al mercado más competitivo, también puede afectar la efectividad de la política monetaria (citar. paper de Eeckhoud). Eso corresponde al BCCh, pero CMF y BCCh comparten como parte de su misión la estabilidad financiera.

    \item Párrafo 8: Primer approach a responder la pregunta de investigación: la estructura de implementación de la CMF ofrece timing temporal en el tratamiento. Eso permite hace un DifDif con heterogeneidad en la introducción del tratamiento. Explicar los peligros de esto, y como solucionarlos (Borusyak et al, etc). 

    \item Párrafo 9: necesitamos un modelo. Escribiremos un modelo teórico con una contraparte empírica. Ejemplos: Allen et al (2019), y Cuesta and Sepúlveda (forthcoming ojalá). Revisar los working papers que están en la página de la CMF. Breve descripción de lo que haríamos.

    \item Párrafos 10-12: revisión de literatura
    \begin{enumerate}
        \item Foley et al y weas parecidas a ese paper. Por qué somos distints
        \item Lit teórica con unsettled questions
        \item ideal 3, pero 2 pueden ser suficientes
    \end{enumerate}
    \item En resumen, pasen lso datos sapos qls.
\end{itemize}
